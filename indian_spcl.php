...
<html class="no-js" lang="">
    <head>
        ...
        <title>Shalimar | Indian Special </title>
            ...
            <div class="inner-page-banner-area">
                <div class="container">
                    <div class="pagination-area">
                        <h2>Indian Spécial</h2>
                        <h3>Juste Le Midi - a Emporter</h3>
                        <ul>
            ...
            <div class="food-menu2-area">
                <div class="container" id="inner-isotope">
                    ...
                    <div class="row featuredContainer">
                             ...
                             <?php
                       $query = mysql_query("SELECT * FROM  sha_products AS pro INNER JOIN sha_product_images AS img ON pro.product_id = img.product_mapping_id where prodcut_category_id=7 group by pro.product_id");
