...
<html class="no-js" lang="">
    <head>
        ...
        <title>Shalimar |Légumes-Vegetables </title>
            ...
            <div class="food-menu2-area">
                <div class="container" id="inner-isotope">
                    ...
                    <div class="row featuredContainer">
						 ...
						 <?php
                       $query = mysql_query("SELECT * FROM  sha_products AS pro INNER JOIN sha_product_images AS img ON pro.product_id = img.product_mapping_id where prodcut_category_id=4 group by pro.product_id");
