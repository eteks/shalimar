...
<html class="no-js" lang="">
    <head>
        ...
        <title>Shalimar|Boeuf-Beef </title>
            ...
            <div class="inner-page-banner-area">
                <div class="container">
                    <div class="pagination-area">
                        <h2>Boeuf-Beef</h2>
                        <ul>
                            <li><a href="food-menu-details.php">Accueil -</a> /</li>
                            <li>Le Menu</li>
                        </ul>
                    </div>
                </div>  
                    ...
                    <div class="row">
                        <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="isotop-classes-tab myisotop"> 
                                <a href="food-menu-details.php" data-filter="*" class="current">All</a>
                                <a href="food-menu-details.php" data-filter=".lunch">Lunch</a>
                                <a href="food-menu-details.php" data-filter=".dinner">Dinner</a>
                                <a href="food-menu-details.php" data-filter=".dessert">Dessert</a>
                                <a href="food-menu-details.php" data-filter=".drinks">Drinks</a>
                            </div>
                        </div> -->
                    </div>
                    <div class="row featuredContainer">
                      <?php
                       $query = mysql_query("SELECT * FROM  sha_products AS pro INNER JOIN sha_product_images AS img ON pro.product_id = img.product_mapping_id where prodcut_category_id=3 group by pro.product_id");
