 <?php		
		...
		<h2 style='background: #a01116; text-align: left; color: #fff; font-weight: bold; font-size: 16px; padding: 10px 10px; margin-bottom: 0;'>
		 ...
		 <center>		 
			...
			<tr><td style='text-align:left;'>Assujettir</td><td style='padding:0 60px 0;'></td>:<td style='text-align:left;'>$subject</td></tr>
                    ...
                    <div class="row">
                            ...
                            <div class="contact-us-left">   
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <h3>Tél</h3>
                                        <p>+ 33 0 1 30 32 71 76</p> 
                                         <p>+ 33 0 9 53 54 11 54</p> 
                                          
                                    </li>
                                    <li>
                                        <i class="fa fa-map-marker" aria-hidden="true"></i>
                                        <h3>Adresse</h3>
                                        <p>13 Place du Petit Martroy, 95300 Pontoise, France</p> 
                                    </li>
                                    <li>
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h3>Email</h3>
                                        <p>arman82.as@gmail.com</p>   
                                    </li>
                                    <li>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <div class="contact-us-right"> 
                                <h2 class="title-bar-medium-left inner-sub-title">Envoyez-nous un Messege</h2>    
                                <div> 							   	
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <input type="text" placeholder="Prénom*" class="form-control" name="name" id="name">
                                                       
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <input type="text" placeholder="Email*" class="form-control" name="email" id="contact_email">
                                                        
                                                    </div>
                                                </div>
                                                 <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <input type="text" placeholder="Assujettir*" class="form-control" name="subject" id="contact_subject">
                                                        
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <textarea placeholder="Message*" class="textarea form-control" name="message" id="contact_message" rows="7" cols="20" ></textarea>
                                                     
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-sm-6">
                                                    <div class="form-group margin-bottom-none">
                                                        <button type="submit" name="check" class="ghost-on-hover-btn">Envoyer</button>
                                                    </div>
                                                </div> 
                                                 <div class="success col-lg-8 col-md-8 col-sm-6 col-xs-6">	
